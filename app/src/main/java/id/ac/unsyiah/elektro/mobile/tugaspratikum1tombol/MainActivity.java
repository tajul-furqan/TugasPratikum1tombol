package id.ac.unsyiah.elektro.mobile.tugaspratikum1tombol;
...
public class MainActivity extends ActionBarActivity {
    ...
    public void onClickTombol (View view) {
        ...
        if (bahasaIndonesia == false){
            String text =getString(R.string.bIndo);
            String tombol =getString(R.string.tmbl_inggris);
            txtTulisan.setText(text);
            button.setText(tombol);
            bahasaIndonesia = true;
        }
        else {
            String text2 = getString(R.string.bIngg);
            String tombol2 = getString(R.string.tmbl_indo);
